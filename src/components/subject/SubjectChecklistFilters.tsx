...
const statusOrder: ChecklistStatus[] = ['PENDIENTE', 'EN_PRODUCCION', 'ENTREGADO', 'APROBADO', 'RECHAZADO', 'NO_EXISTE'];
...
const activeTint: Record<SubjectChecklistFilter, string> = {
  ...
  RECHAZADO: 'border-rose-200 bg-rose-50 text-rose-950 shadow-md ring-2 ring-rose-100/80',
