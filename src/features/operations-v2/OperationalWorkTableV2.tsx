    ...
    <Card className="overflow-hidden p-0">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200/60 bg-white px-5 py-3.5 sm:px-6">
        <div>
          ...
          <h2 className="text-sm font-semibold text-slate-900">Asignaturas</h2>
        </div>
          ...
          <div className="hidden overflow-auto md:block">
            <table className="w-full min-w-[920px] text-sm">
              <thead className="bg-slate-50/90 text-[11px] font-semibold uppercase tracking-wide text-slate-500">
                <tr>
                  <th className="px-5 py-2.5 text-left sm:px-6">Asignatura</th>
                  {flowOnly ? (
                ...
                {isLoading
                  ...
                  : items.map((item) => (
                      <tr
                        ...
                        onClick={flowOnly ? () => handleRowOpen(item.subjectId) : undefined}
                      >
                        ...
                        >
                          {flowOnly ? (
                            <FlowOpenButton onClick={() => props.onOpenFlow(item.subjectId)} />
                          ) : (
