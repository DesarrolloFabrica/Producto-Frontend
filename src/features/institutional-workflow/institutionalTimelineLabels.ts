...
const ACTION_TIMELINE_LABELS: Record<InstitutionalOperationalAction, string> = {
  ...
  PLANNING_VALIDATE_INITIAL: 'Planeaci?n valid? solicitud inicial',
  PLANNING_RETURN_INITIAL: 'Planeaci?n devolvi? a Product',
  PRODUCT_RESUBMIT_REQUEST: 'Product reenvi? solicitud',
  FACTORY_START_PRODUCTION: 'F?brica inici? producci?n',
  FACTORY_DELIVER_CONTENT: 'F?brica entreg? producci?n a Planeaci?n',
  PLANNING_VALIDATE_PRODUCTION: 'Planeaci?n aprob? producci?n',
  PLANNING_RETURN_PRODUCTION: 'Planeaci?n devolvi? producci?n a F?brica',
  LMS_START_UPLOAD: 'LMS inici? carga',
  LMS_CONFIRM_UPLOAD: 'LMS confirm? publicaci?n',
  PLANNING_VALIDATE_LMS: 'Planeaci?n valid? LMS',
  PLANNING_RETURN_LMS: 'Planeaci?n devolvi? carga LMS',
...
const LEGACY_ACTION_TIMELINE_LABELS: Record<string, string> = {
  PLANNING_FINALIZE: 'Planeaci?n radic? y finaliz?',
};
