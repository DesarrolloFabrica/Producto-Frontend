...
import { productSemesterOperationsPath } from './institutionalNavigation';
...
export function AcademicReviewReadyView({ workspace }: AcademicReviewReadyViewProps) {
  const semesterOpsUrl = productSemesterOperationsPath(workspace.projectId, workspace.semesterNumber);
