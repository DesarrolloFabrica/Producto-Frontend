import type { ActivityEvent, AuditLog, ChecklistItem, ChecklistStatus, Notification, OperationalObservation, PipelineStageSummary, SubjectVirtualization, VirtualizationProject } from '../types/domain';
...
const subjectsFor = (projectId: string, semester: number, names: string[]): SubjectVirtualization[] =>
  names.map((name, index) => {
    ...
    return {
      ...
      name,
      status: checklist[index % checklist.length].status,
      ...
      contentTopics: ['Contexto disciplinar', 'Marco conceptual', 'Actividades aplicadas', 'Evaluacion y cierre'],
    };
  });
...
export const projects: VirtualizationProject[] = [
  {
    ...
    semesters: [
      { id: 'vp-001-sem-1', semesterNumber: 1, curriculumStatus: 'APROBADO', factoryStatus: 'ENTREGADO', factoryExpectedDate: '2026-05-16', continuationDate: '2026-05-22', observations: 'Semestre listo para revision academica.' },
      { id: 'vp-001-sem-2', semesterNumber: 2, curriculumStatus: 'ENTREGADO', factoryStatus: 'EN_PRODUCCION', factoryExpectedDate: '2026-05-24', continuationDate: '2026-05-29', observations: 'Faltan evaluaciones y lecturas.' },
      { id: 'vp-001-sem-3', semesterNumber: 3, curriculumStatus: 'PENDIENTE', factoryStatus: 'PENDIENTE', factoryExpectedDate: '2026-06-03', continuationDate: '2026-06-07', observations: 'Pendiente confirmacion de syllabus.' },
    ],
    subjects: [
  ...
  },
  {
    ...
    semesters: [
      { id: 'vp-002-sem-4', semesterNumber: 4, curriculumStatus: 'APROBADO', factoryStatus: 'PENDIENTE', factoryExpectedDate: '2026-05-28', continuationDate: '2026-06-02', observations: 'Priorizado por calendario academico.' },
      { id: 'vp-002-sem-5', semesterNumber: 5, curriculumStatus: 'ENTREGADO', factoryStatus: 'PENDIENTE', factoryExpectedDate: '2026-06-05', continuationDate: '2026-06-12', observations: 'Revisar bibliografia base.' },
    ],
    subjects: [
  ...
  },
  {
    ...
    semesters: [
      { id: 'vp-003-sem-1', semesterNumber: 1, curriculumStatus: 'ENTREGADO', factoryStatus: 'EN_PRODUCCION', factoryExpectedDate: '2026-05-10', continuationDate: '2026-05-15', observations: 'Atrasado por validacion de recursos visuales.' },
      { id: 'vp-003-sem-2', semesterNumber: 2, curriculumStatus: 'APROBADO', factoryStatus: 'ENTREGADO', factoryExpectedDate: '2026-05-12', continuationDate: '2026-05-18', observations: 'Entregables principales cerrados.' },
    ],
    subjects: [
